...
from Analytics.Correlation import CorrelationMethods
...
class App:
    ...
    def calculate_correlations(self):
        CorrelationPump.store_data(data=CorrelationMethods.get_country_correlations(self.indicator_cols))
        CorrelationPump.store_data(data=CorrelationMethods.get_global_correlations(self.indicator_cols))
        CorrelationPump.store_data(data=CorrelationMethods.get_regional_correlations(self.indicator_cols))
